...
//             auto dy_row = xt::view(DY, i, xt::all());
//             auto x_row = xt::view(m_aCached_X, i, xt::all());
//             xt::xarray<double> outer_product = outer_stack(dy_row, x_row);
//             xt::view(dW_batch, i, xt::all(), xt::all()) = outer_product;
//         }
